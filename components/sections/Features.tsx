...
function MockProntuario() {
  ...
  return (
    <div className="rounded-[18px] bg-neutro-0 p-4 shadow-[0_12px_40px_-16px_rgba(58,72,94,0.4)]">
        ...
        {tabs.map((t, i) => (
          <span
            ...
            className={
              ...
              (i === 0 ? "bg-brand text-white" : "bg-neutro-100 text-neutro-500")
            }
          >
            {t}
          </span>
      ...
      <div className="mt-3 divide-y divide-neutro-200/60 rounded-[14px] bg-neutro-50/70 px-3.5">
        <Row label="Queixa principal" value="Cansaço e ganho de peso" />
        <Row label="Restrições" value="Intolerância à lactose" />
        <Row label="Rotina" value="Sono irregular · sedentária" />
      </div>
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 md:px-10 lg:px-16">
        ...
        >
          ...
          {/* B — texto + conversa (topo-dir) */}
          <article data-card className={CARD + " lg:col-start-2 lg:row-start-1"}>
            <div className="flex h-full flex-col p-7 md:p-8">
              ...
              <div className="relative mt-6 h-[280px] flex-1 overflow-hidden rounded-[16px]">
                <MockConversa />
              </div>
            </div>
          </article>
          ...
          <div className="flex flex-col gap-4 md:gap-5 lg:col-start-2 lg:row-start-2">
            ...
            <article data-card className={CARD + " flex-1"}>
              <div className="flex h-full flex-col p-7 md:p-8">
                ...
                <CardBody>
                  Sua agenda do Google, com link de teleconsulta criado sozinho.
                  Sem trocar de aba.
                </CardBody>
                <div className="mt-6">
                  <MockFollowup />
