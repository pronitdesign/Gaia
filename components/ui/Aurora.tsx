...
// Aurora WebGL (React Bits) — véu de aurora animado. Portado pra TSX + paleta Gaia.
// Renderiza numa <canvas> transparente que preenche o container pai (position: absolute).
...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const time = t * 0.01;
      program!.uniforms.uTime.value = time * (p.speed ?? 1.0) * 0.1;
  ...
  return <div ref={ctnDom} className={className ?? "h-full w-full"} />;
}
